...
resource "azurerm_container_group" "hq_ipfs_gateway_acg" {
  ...
  container {
    ...
    #   "reverse-proxy",
    #   "--from",
    #   "${var.dns_name_label}.${var.location}.azurecontainer.io/api/*",  # API endpoints
    #   "--to",
    #   "http://${var.dns_name_label}.${var.location}.azurecontainer.io:5001",
    #   "--from",
    #   "${var.dns_name_label}.${var.location}.azurecontainer.io/ipfs/*", # Gateway endpoints
    #   "--to",
    #   "http://${var.dns_name_label}.${var.location}.azurecontainer.io:8080"
    # ]
